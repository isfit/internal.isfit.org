class Wiki::WikiPagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wiki_page.save
        format.html { redirect_to [:wiki,@wiki_page], notice: 'Wiki page was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @wiki_page.save
        format.html { redirect_to [:wiki,@wiki_page], notice: 'Wiki page was successfully updated.' }
