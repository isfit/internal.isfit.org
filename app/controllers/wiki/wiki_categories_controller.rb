class Wiki::WikiCategoriesController < ApplicationController
  # GET /wiki_categories
  ...
  def create
    ...
    respond_to do |format|
      if @wiki_category.save
        format.html { redirect_to [:wiki,@wiki_category], notice: 'Wiki category was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @wiki_category.update_attributes(params[:wiki_category])
        format.html { redirect_to [:wiki,@wiki_category], notice: 'Wiki category was successfully updated.' }
